    ...
    <div className='grid lg:grid-cols-5 gap-4 p-4'>
        <div className='lg:col-span-2 col-span-1 bg-white flex justify-between w-full border p-4 rounded-lg'>
            <div className='flex flex-col w-full pb-4'>
                <p className='text-2xl font-bold'>$7,223</p>
                <p className='text-slate-700'>Daily Revenue</p>
            </div>
        ...
        <div className='lg:col-span-2 col-span-1 bg-white flex justify-between w-full border p-4 rounded-lg'>
            <div className='flex flex-col w-full pb-4'>
                <p className='text-2xl font-bold'>$257,223,526</p>
                <p className='text-slate-700'>YTD Revenue</p>
            </div>
            <p className='bg-green-300 flex justify-center items-center p-2 rounded-lg'>
        ...
        <div className='bg-white flex justify-between w-full border p-4 rounded-lg'>
            <div className='flex flex-col w-full pb-4'>
                <p className='text-2xl font-bold'>600,893</p> 
